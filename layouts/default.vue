...
<template>
  <div>
    ...
    <main>
      ...
      >
        <section class="flex flex-row justify-center xl:justify-between">
          <aside
            class="hidden xl:flex flex-1 border-l-2 border-r-2 dark:border-gray-700 bg-white dark:bg-gray-800"
          >
            <NavigationPanelLeft />
          </aside>
          ...
          <section>
            ...
            <UContainer
              :ui="{
                ...
                constrained:
                  'max-w-[35rem] sm:max-w-[40rem] md:max-w-[45rem] lg:max-w-[60rem] xl:max-w-4xl 2xl:mx-w-3xl ',
              }"
            >
              <!-- Mobile Menu -->
